...
const teamData = [
  ...
  },
  {
    ...
    social: [
      ...
      { platform: "Instagram", iconClass: "fab fa-instagram", link: "https://www.instagram.com/tekashi_profile" },
      { platform: "Facebook", iconClass: "fab fa-facebook-f", link: "https://www.facebook.com/tekashi_profile" },
      { platform: "LinkedIn", iconClass: "fab fa-linkedin-in", link: "https://www.linkedin.com/in/tekashi_profile" }
    ]
  },
  {
    name: "Valentine",
